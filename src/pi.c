...
int RS232P(char * wrstring, short * lwr, char * rdstring, short * lrd, \
       short * reply)
{
  char talkstring[80];
  int  len;
...
int PIAXISNO(int motorno, int * axis) 
{
  /*
  int n;
...
int PISETPOS(int * motorno, int * pulses) 
{
  short lt, lc, reply;
  int axis;
  int retn;
...
int PIGETPOS(int * motorno, int * pulses) 
{
  short lt, lc, reply;
  int axis;
  int retn;
...
int PISETVEL(int * motorno, int * prate) 
{
  short lt, lc, reply;
  int axis;
  int retn;
...
int PISETACC(int * motorno, int * acc) 
{
  short lt, lc, reply;
  int axis;
  int retn;
...
int PIGOPOS(int * motorno, int * pulses) 
{
  short lt, lc, reply;
  int axis;
  int retn;
...
int PISTATUS(int * motorno, int * moving, int * limstat) 
{
  short lt, lc, reply;
  int axis;
  int retn, n;
...
int PILIMSTAT(int * motorno, int * limstat) 
{
  short lt, lc, reply;
  char * ptr, ch;
  int retn, axis;
